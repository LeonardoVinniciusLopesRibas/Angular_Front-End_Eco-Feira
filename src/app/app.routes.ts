...
import {
  PrincipalprefeituraComponent
} from './components/layout/prefeitura/principalprefeitura/principalprefeitura.component';
import {DemandaprefeituraComponent} from './components/layout/prefeitura/demandaprefeitura/demandaprefeitura.component';
import {
  ProdutoprefeituradetailsComponent
} from './components/layout/prefeitura/produtoprefeituradetails/produtoprefeituradetails.component';
import {
  ProdutoprefeituraeditnewComponent
} from './components/layout/prefeitura/produtoprefeituraeditnew/produtoprefeituraeditnew.component';
import {
  UsuarioprefeituradetailsComponent
} from './components/layout/prefeitura/usuarioprefeituradetails/usuarioprefeituradetails.component';
...
export const routes: Routes = [
  ...
  {path: 'admin/prefeitura', redirectTo: 'admin/prefeitura/demanda', pathMatch: 'full'},
  {
    ...
    children: [
      ...
      {path: 'atender/gerenciar/:id', component: AtendergerenciardemandaComponent, canActivate: [loginGuard]}
