...
import { CentralDadosListComponent } from './components/central-dados-list/central-dados-list.component';
...
import { ProdutorComponent } from './components/layout/produtor/produtor.component';
...
export const routes: Routes = [
    ...
    {
        path: 'admin/produtor', component: ProdutorComponent, canActivate: [loginGuard],
        children: [
